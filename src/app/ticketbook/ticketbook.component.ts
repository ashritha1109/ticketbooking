...
export class TicketbookComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.service.getSingleMovieData(this.id).subscribe((data) => {
      console.log(data);
      this.ticketDetails.controls.name.setValue(data.name);
      this.ticketDetails.controls.lang.setValue('English');
        ...
        if (this.movieDetails.morning_show < tickets) {
          ...
          if (tickets != null) {
            ...
            localStorage.setItem(
              'ticketdeets',
              JSON.stringify(this.ticketDetails.value)
            );
            this.service
              .editTicketsData({ ...this.movieDetails, id: this.id })
              .subscribe((data) => {
                alert('edited');
            ...
            this.service
              .postTicketDetails(this.ticketDetails.value)
              .subscribe((data) => {
                console.log(data);
